# Remove all custom ConceptSphere Desktop and navigation-pane namespace entries.
...
Write-Host ""
Write-Host "All custom ConceptSphere Desktop and navigation-pane entries were removed."
